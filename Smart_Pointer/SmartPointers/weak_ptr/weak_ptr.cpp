...
int main()
{
	...
	// so to solve this weak ptr is created where assiging to weak ptr does not increase ownership count 
	...
	if(!weakPtr1.expired())
	{
		cout<<"Not Expired and value of size = " ;
		cout<<(*weakPtr1.lock()).size <<endl;
		cout<<endl;
	}
	else
	{
		cout<<"Shared Ptr Expired\n";
	}
