...
int main()
{
	...
	if(!sharePtr2->b.expired())
	{
		cout<<"Value = " << (sharePtr2->b.lock())->d <<endl;
		cout<<"Value = " << (sharePtr2->b.lock())->dd <<endl;
...
cout<<"---------------------------------------\n";
	...
	// assigning to the weakptr does not increase reference count 
	weak_ptr<Sample1> weakSampel = sharePtr2;
