...
class A
{
	...
	int size;
	int * ptr;
		// when there is no special member functions in a class the compiler a class with special member created and it does a shallow copy so double delete error occurs  
