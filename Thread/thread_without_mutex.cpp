...
void *print_data_member_3(void * arg)
{
    // while(true)
    // {
    //     cout<<"------------------------ Thread 2 function ------------------------\n";
...
void *print_data_member_4(void * arg)
{
    // while(true)
    // {
    //     cout<<"------------------------ Thread 2 function ------------------------\n";
...
void *print_data_member_5(void * arg)
{
    // while(true)
    // {
    //     cout<<"------------------------ Thread 2 function ------------------------\n";
...
int main()
{
    ...
    if(pthread_create(&thread_3,NULL , print_data_member_3, v_ptr)!=0)
    {
        cout<<"Pthread_3 Creation problem \n";
        return 0;
    }
    cout <<"Pthread_3 created with no problem ...\n";

    if(pthread_create(&thread_4,NULL , print_data_member_3, v_ptr)!=0)
    {
        cout<<"Pthread_4 Creation problem \n";
        return 0;
    }
    cout <<"Pthread_4 created with no problem ...\n";

     if(pthread_create(&thread_5,NULL , print_data_member_3, v_ptr)!=0)
    {
        cout<<"Pthread_5 Creation problem \n";
        return 0;
    }
    cout <<"Pthread_5 created with no problem ...\n";
