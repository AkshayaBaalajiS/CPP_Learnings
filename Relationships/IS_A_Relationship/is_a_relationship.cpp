// inheritance is a example of the is a relationship 
#include<iostream>
using namespace std;
...
class childClass : public baseClass  // childClass is a baseClass 
{
    public :
        childClass()
        {
...
int main()
{
        cout<<"This is a program to demonstrate the Is a Relationship in c++ \n";
